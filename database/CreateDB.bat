...
mysql -u root -p --password=123456 mediapp < currval.sql 
mysql -u root -p --password=123456 mediapp < nextval.sql 
...
mysql -u root -p --password=123456 mediapp< create_calendar.sql 
pause