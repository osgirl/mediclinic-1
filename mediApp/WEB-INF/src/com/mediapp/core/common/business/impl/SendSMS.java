...
public class SendSMS {
    ...
    public  synchronized  void sendSMSForRescheduledAppointment( Appointment  appointment, NotificationDetails notificationDetails) throws Exception{
		Service srv;
		OutboundMessage msg;
		OutboundNotification outboundNotification = new OutboundNotification();
		srv = new Service();
		...
		msg = new OutboundMessage(notificationDetails.getDoctorMobileNumber(), notificationDetails.getPatientName()+" has rescheduled appointment to "+appointment.getDateOfAppointment()+". Please logon and confirm.Thanks.");
		srv.sendMessage(msg);
		System.out.println(msg);
		srv.stopService();
    }
    ...
    public  synchronized  void sendSMSForAllCancelledAppointment( Appointment  appointment, NotificationDetails notificationDetails) throws Exception{
		Service srv;
		OutboundMessage msg;
		OutboundNotification outboundNotification = new OutboundNotification();
		srv = new Service();
		...
		msg = new OutboundMessage(notificationDetails.getPatientMobileNumber(),"Appointment has been cancelled on "+appointment.getDateOfAppointment()+". Please logon and confirm.Thanks.");
		srv.sendMessage(msg);
		System.out.println(msg);
		srv.stopService();
    }
    ...
    public  synchronized  void sendErrorSMS( String cellPhoneNumbers,String message) throws Exception{
		Service srv;
		OutboundMessage msg;
		OutboundNotification outboundNotification = new OutboundNotification();
		srv = new Service();
		...
		msg = new OutboundMessage(cellPhoneNumbers,message);
		srv.sendMessage(msg);
		System.out.println(msg);
		srv.stopService();
    }
