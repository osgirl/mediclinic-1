...
FCKConfig.ToolbarSets["Default"] = [
	...
	['Link','Unlink','Anchor'],
	['Rule','SpecialChar','Table'],
	['Image','Smiley','TextColor','BGColor'],
	['FitWindow'],
...
FCKConfig.ImageUploadURL = FCKConfig.BasePath + 'filemanager/upload/' + _QuickUploadLanguage + '/upload.' + _QuickUploadLanguage + '?Type=Image&uuid=' + FCKConfig.uuid;
