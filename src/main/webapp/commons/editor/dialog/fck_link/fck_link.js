...
function OnUploadCompleted( errorNumber, fileUrl, fileName, customMsg )
{
	...
	{
		case 0 :	// No errors
			alert( FCKLang.UploadMessageNoError ) ;
			break ;
		case 1 :	// Custom error
			alert( customMsg ) ;
			return ;
		case 101 :	// Custom warning
			...
			break ;
		case 201 :
			alert( FCKLang.UploadMessageSameName + '"' + fileName + '"' ) ;
			break ;
		case 202 :
			alert( FCKLang.UploadMessageInvalidType ) ;
			return ;
		case 203 :
			alert( FCKLang.UploadMessageSecurityError ) ;
			return ;
		default :
			alert( FCKLang.UploadMessageUploadError + errorNumber ) ;
			return ;
	}
