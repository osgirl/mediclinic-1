...
// custom
UploadMessageNoError : "文件上传成功",
UploadMessageSameName : "文件上传成功,但存在一个同名文件,当前文件被改名为:",
UploadMessageInvalidType: "文件上传失败,不允许上传该文件类型",
UploadMessageSecurityError: "文件上传失败,服务器异常",
UploadMessageUploadError: "文件上传失败,未知错误号:"
};